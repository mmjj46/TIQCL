...
""" Connection """
setup_connection = True  # True: Local | False: Remote

# in case of False (=Remote connection)...
ip_address = "192.168.0.17"
inst_number = "inst2"  # inst0 ~ inst5

# *** Basic parameter 설정 ----------------------------------------------------------

""" Repetition """  # (=> SPC_LOOPS)
rep_number = 500  # 0: infinite loop
...
ch_number = 1  # 0: CH0 | 1: CH1 | 2: CH0 & CH1 (both)

ch_enable0 = 0  # 0: OFF | 1: PLUS (ON) | 2: MINUS
ch_enable1 = 1  # 0: OFF | 1: PLUS (ON) | 2: MINUS
...
""" Ext. Trigger """
trig_number = 0  # 0 or 1: External Trigger | 2: Software Trigger
...
setup_ext_clock = True  # ON/OFF (always ON)
clock_MHz = 10  # MHz
...
# Remote 연결 # ip_address 와 inst_number 반영, b'TCPIP[0]::ip_address::inst_number::INSTR'
elif setup_connection == False:
	hCard = spcm_hOpen(
		create_string_buffer(b'TCPIP[0]::192.168.0.17::inst2::INSTR'))  # inst2: card index (6Cards 2channels per card)
